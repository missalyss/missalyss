...
const About = () => {
  ...
  return (
    <div className="max-width mx-auto">
      <h1 className="bg-blue p4 text-lg">Hello!</h1>
      <h2 className="bg-blue-light p4 text-md">
        My name is Alyssa. (she/her/they/them)
      </h2>
      <p className="bg-blue p2 text-left">
      ...
      <ol className="pl0">
        <li className="bg-blue-light list-inside p2 text-left">
